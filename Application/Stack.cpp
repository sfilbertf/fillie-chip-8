...
void Application::stack() {
    ...
    ImGui::SetNextWindowPos(ImVec2(io.DisplaySize.x * 0.875f, io.DisplaySize.y * 0.6625f), ImGuiCond_Always, ImVec2(0.5f,0.5f));
    ImGui::SetNextWindowSize(ImVec2(io.DisplaySize.x * 0.175f, io.DisplaySize.y * 0.625f), ImGuiCond_Always);
